...
const McareIntroDemo           = lazy(() => import('@/pages/McareIntroDemo'));
...
export const publicRoutes = (
  <Route key="public-layout" element={<ErrorBoundary><AppLayout /></ErrorBoundary>}>
    ...
    <Route path="/system-status" element={<ErrorBoundary><SystemHealth /></ErrorBoundary>} />
    ...
    <Route path="/demo/mcare-intro"     element={<ErrorBoundary><McareIntroDemo /></ErrorBoundary>} />
