    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-emerald-900 to-slate-900 flex items-center justify-center p-6">
        <motion.div initial={{ scale: 0.9, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} className="max-w-md w-full text-center">
          ...
          <h1 className="text-3xl font-bold text-white mb-2">You're Marked Safe</h1>
        ...
        <div className="max-w-lg mx-auto space-y-4 pt-4">
          ...
          <motion.div initial={{ opacity: 0, y: -8 }} animate={{ opacity: 1, y: 0 }}
            ...
            <div className="flex items-center gap-3 mb-3">
              ...
              <p className="text-purple-300 text-xs font-bold uppercase tracking-widest">Safety Mode Active</p>
            </div>
          ...
          <div className="bg-slate-800/60 border border-slate-700/40 rounded-2xl p-4 space-y-3">
            <p className="text-xs font-bold text-slate-400 uppercase tracking-wide">Safety Status</p>
            {[
          ...
          <div className="bg-amber-900/30 border border-amber-700/40 rounded-2xl p-4 text-sm text-amber-200">
            <p className="font-bold mb-1 flex items-center gap-2"><Clock className="w-4 h-4" />Check-in reminder every {intervalMins} min</p>
          ...
          <div className="space-y-3">
            <Button onClick={handleConfirmSafe} disabled={loading}
              className="w-full bg-emerald-600 hover:bg-emerald-700 text-white h-14 text-base font-bold gap-3">
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-950/20 to-slate-900 p-4">
      <div className="max-w-lg mx-auto space-y-5 pt-4 pb-12">
        ...
        <div className="text-center">
          ...
          <h1 className="text-2xl font-bold text-white">Activity Safety Mode</h1>
        ...
        <div className="bg-slate-800/60 border border-slate-700/40 rounded-2xl p-4">
          <p className="text-xs font-bold text-slate-400 uppercase tracking-wide mb-3">What are you doing?</p>
        ...
        <div className="bg-slate-800/60 border border-slate-700/40 rounded-2xl p-4 space-y-3">
          <p className="text-xs font-bold text-slate-400 uppercase tracking-wide">Where are you going? (optional)</p>
        ...
        {/* Step 3: Timing */}
        <div className="bg-slate-800/60 border border-slate-700/40 rounded-2xl p-4 space-y-3">
          <p className="text-xs font-bold text-slate-400 uppercase tracking-wide">Return estimate</p>
          ...
          <p className="text-xs font-bold text-slate-400 uppercase tracking-wide mt-2">Check-in frequency</p>
          <div className="flex gap-2 flex-wrap">
        ...
        {!hasPIN && (
          <div className="bg-amber-900/30 border border-amber-700/40 rounded-xl p-3 flex items-start gap-2">
            ...
            <div className="text-xs text-amber-300">
              <p className="font-bold">⚠️ Emergency PIN not set</p>
        ...
        <Button onClick={handleStart} disabled={loading}
          className="w-full bg-purple-600 hover:bg-purple-700 text-white h-14 text-base font-bold gap-3">
