...
const DOCTORS = [
  {
    ...
    result: {
      ...
      ai_red_flags: [],
      agent_reasoning: [
        'Device: Chrome on Mac — legitimate browser. Full scan sequence initiated.',
        'IP: residential (San Diego, CA). Location consistent with US-based coordinator for Mexico clinic.',
        'Phone: no immediate flags. Standard weighting applied.',
        'Fraud graph: no cross-partner matches. Phone is unique to this application.',
        'Domain: 96mo old (established) — positive credibility signal.',
        'Social: 5/5 platforms verified live. Strong social footprint.',
        'Agent synthesis: 0 critical signals. Pre-synthesis score: 18/100. Invoking AI narrative.',
      ],
  ...
  },
  {
    ...
    result: {
      ...
      agent_reasoning: [
        'Device: Chrome on Windows — legitimate browser. Full scan sequence initiated.',
        'IP routes through Cloudflare datacenter — proxy infrastructure detected. Escalating fraud priority.',
        'IP: timezone conflict — New York timezone on Bogotá registration. Cross-border discrepancy flagged.',
        'Phone: no immediate flags. Standard weighting applied.',
        'Fraud graph [ESCALATED]: cross-referencing phone across all 4 partner entity types.',
        'Fraud graph: address prefix matches 1 prior application submitted 3 months ago.',
        'Domain: 24mo old (new) — inconsistent with claimed 10-year practice history.',
        'Social: 2/5 platforms verified live. Partial presence.',
        'Agent synthesis: 2 escalation signals. Pre-synthesis score: 41/100. Invoking AI narrative.',
      ],
  ...
  },
  {
    ...
    result: {
      ...
      ai_red_flags: [],
      agent_reasoning: [
        'Device: Safari on MacBook M3 — legitimate browser. Full scan sequence initiated.',
        'IP routes through professional VPN (Dubai, UAE) — escalating fraud check. VPN exception rule queued.',
        'Phone: no immediate flags. Standard weighting applied.',
        'Fraud graph: no cross-partner matches. Phone is unique to this application.',
        'Domain: no website — traveling surgeon model expected for multi-hospital practice.',
        'Social: 3/5 platforms live. LinkedIn active — 4,200+ connections, 3 PubMed publications.',
        'Agent synthesis: VPN detected but zero shared infrastructure + 8 prior completed cases. Exception rule applied. Pre-synthesis score: 29/100.',
      ],
  ...
  },
  {
    ...
    result: {
      ...
      agent_reasoning: [
        'CRITICAL: Headless browser detected — automated signup bot. Fast-path escalation triggered.',
        'CRITICAL: IP is a Tor exit node — full identity obfuscation. Fraud checks elevated immediately.',
        'Phone prefix matches VoIP pattern — synthetic identity signal. Fraud graph running before domain/social.',
        'CRITICAL: Fraud graph hit — phone shared across 4 partner records in 180 days. Confirmed fraud cluster.',
        'CRITICAL: Device fingerprint b3f71a linked to 3 previously suspended applications. Fraud factory confirmed.',
        'Risk score 94/100 — critical threshold reached. Domain and social checks bypassed.',
        'Agent synthesis: 5 critical signals. Pre-synthesis score: 94/100. Invoking AI narrative — DO NOT ACTIVATE.',
      ],
