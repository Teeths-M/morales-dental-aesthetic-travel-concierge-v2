...
const getSteps = (language) => [
  ...
  { icon: ClipboardList, num: 2, title: language === 'es' ? 'Plan Personalizado y Presupuesto' : language === 'fr' ? 'Plan Personnalisé et Devis' : 'Personalized Plan & Quote', desc: language === 'es' ? 'Recibe un plan de tratamiento detallado con precios transparentes. Nuestro equipo de seguridad revisa tu perfil y confirma el enfoque más seguro para tus necesidades.' : language === 'fr' ? 'Recevez un plan de traitement détaillé avec une tarification transparente. Notre équipe de sécurité examine votre profil et confirme l\'approche la plus sûre pour vos besoins.' : 'Receive a detailed treatment plan with transparent pricing. Our safety team reviews your profile and confirms the safest approach for your specific health needs.', color: 'bg-[#00E5FF]/10 text-[#00E5FF]' },
