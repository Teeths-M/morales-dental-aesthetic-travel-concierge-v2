  ...
  return (
    <div className="min-h-screen bg-gray-50 font-inter">
      ...
      <section className="relative h-screen overflow-hidden bg-gray-100">
        ...
        {/* Hero Content */}
        <div className="relative z-10 h-full flex items-center justify-center -mt-80">
          <div className="text-center px-4">
            ...
            <div className="flex items-center justify-center gap-4">
              <button className="px-6 py-3 rounded-full bg-gray-300 text-gray-800 font-medium hover:bg-gray-400 transition-colors">
                Discover
              </button>
              <button
                ...
                onMouseEnter={(e) => {
                  e.target.style.backgroundColor = '#1a2229';
                }}
                onMouseLeave={(e) => {
                  e.target.style.backgroundColor = '#202A36';
                }}
              >
                Book Now
              </button>
