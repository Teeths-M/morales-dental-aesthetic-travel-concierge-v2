  ...
  return (
    <div style={{ minHeight: '100vh', background: DARK, fontFamily: '"SF Pro Display", system-ui, sans-serif' }}>
      ...
      <div style={{ maxWidth: 560, margin: '0 auto', padding: '28px 20px' }}>
        {/* Production badge */}
        <div style={{ display: 'inline-flex', alignItems: 'center', gap: 8, padding: '7px 14px', borderRadius: 10, background: 'rgba(245,158,11,0.06)', border: '1px solid rgba(245,158,11,0.3)', marginBottom: 20 }}>
          <span style={{ fontSize: 13 }}>⚠️</span>
          <span style={{ fontSize: 11, fontWeight: 700, color: '#f59e0b' }}>Representative showcase — live engine runs on real patient data</span>
        </div>
