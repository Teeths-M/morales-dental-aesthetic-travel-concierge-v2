  ...
  },
  {
    ...
    actions: [
      ...
      },
      {
        ...
        icon: '👩🏽‍⚕️',
        color: PURPLE,
        message: 'James may experience altitude sickness on arrival — headache, fatigue, shortness of breath. Keep him hydrated, at rest, and indoors for the first 24 hours. Avoid stairs where possible.',
        mDid: 'Altitude sickness protocol sent · Rest schedule locked for Day 1 · Elevator-only hotel confirmed',
      },
      {
        to: 'Dr. Ramírez (Clinic)',
        icon: '👨🏽‍⚕️',
        color: GREEN,
        message: 'Patient arriving from sea-level Trinidad to Bogotá (2,600m). Altitude may affect anaesthesia response and post-op breathing after rhinoplasty. Recommend pre-procedure altitude check and extended monitoring.',
        mDid: 'Altitude pre-check added to procedure · Extended post-op monitoring flagged · Anaesthesia note sent to surgical team',
      },
      {
        to: 'Carlos (Driver)',
        icon: '🚗',
        color: BLUE,
        message: 'Patient may be experiencing altitude adjustment. Please drive smoothly — avoid sharp stops. Keep vehicle warm. If patient appears unwell, contact M concierge immediately.',
        mDid: 'Driver altitude protocol sent · Emergency contact pre-loaded · Smooth-drive preference logged',
      },
    ],
  },
];
