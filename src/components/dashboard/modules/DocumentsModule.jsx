    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-3 gap-4">
        {[
          ...
          <div key={s.label} className="bg-white border border-slate-100 rounded-2xl shadow-sm p-4 text-center">
            <p className={`text-2xl font-bold ${s.color === 'emerald' ? 'text-emerald-600' : s.color === 'amber' ? 'text-amber-600' : 'text-red-600'}`}>{s.value}</p>
      ...
      {missing > 0 && (
        <div className="bg-amber-50 border border-amber-100 rounded-2xl px-5 py-4 flex items-start gap-3">
          ...
          <div>
            <p className="text-sm font-bold text-amber-800">SAFE-T 4LIFE™ Document Alert</p>
