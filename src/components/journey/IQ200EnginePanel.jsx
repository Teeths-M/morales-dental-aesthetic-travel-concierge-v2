    ...
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between flex-wrap gap-2">
        <div className="flex items-center gap-2">
          ...
          <div>
            <p className="text-sm font-semibold text-slate-800">iQ200 Coordination Engine</p>
        ...
        <div>
          {needsInit ? (
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }}
              ...
              <p className="text-sm font-semibold text-slate-700 mb-1">iQ200 Engine Not Yet Initialized</p>
              ...
              <button
                ...
                className="px-6 py-2.5 bg-gradient-to-r from-emerald-700 to-blue-800 text-white text-xs font-semibold rounded-xl hover:opacity-90 transition-all disabled:opacity-50 flex items-center gap-2 mx-auto"
              >
                {initializing ? (
      ...
      {activeTab === 'audit' && (
        <div className="space-y-3">
          <div className="flex items-center gap-2 mb-1">
            ...
            <p className="text-xs font-semibold text-slate-600 uppercase tracking-wide">Immutable Cryptographic Audit Trail</p>
          </div>
          {auditLogs.length === 0 ? (
