...
// Helpers — include applyUrl for direct links
const VF = (days, notes, reqs=[], applyUrl=null) => ({ status: 'visa_free', days, notes, applyUrl, requirements: ['Valid passport (6+ months)', 'Return ticket', ...reqs] });
const EV = (days, notes, reqs=[], applyUrl=null) => ({ status: 'evisa', days, notes, applyUrl, requirements: ['Valid passport (6+ months)', 'e-Visa approval', ...reqs] });
const VR = (days, notes, reqs=[], applyUrl=null) => ({ status: 'visa_required', days, notes, applyUrl, requirements: ['Valid passport (6+ months)', 'Visa application', 'Bank statements', 'Hotel booking', ...reqs] });
const AC = (days, notes, reqs=[], applyUrl=null) => ({ status: 'arrival_card', days, notes, applyUrl, requirements: ['Valid passport (6+ months)', 'Tourist card fee', 'Return ticket', ...reqs] });
...
export const VISA_RULES = {
  ...
  US: {
    ...
    TH: VF(60, 'Visa-free for 60 days. e-Visa available for longer stays', ['Proof of funds'], 'https://www.thaievisa.go.th/'),
    TR: EV(90, 'e-Visa required — apply at official Turkish e-Visa portal (USD 50, instant approval)', ['Travel insurance recommended'], 'https://www.evisa.gov.tr/en/'),
    MX: VF(180, 'No visa required — up to 180 days. FMM tourist form completed on arrival'),
    CR: VF(180, 'No visa required — up to 180 days (US citizens). Return ticket required', ['Return ticket', 'Proof of funds ($100/day)']),
    BR: EV(90, 'e-Visa required for US citizens since April 2025 — apply at Brazil eVisa portal', ['Proof of accommodation', 'Return ticket'], 'https://brazil.vfsevisa.com/homepage'),
    PA: VF(180, 'No visa required — up to 180 days. Return ticket and proof of funds required', ['Proof of funds ($500 minimum)']),
  },
  // ── Canada ──
  CA: {
    ...
    TH: VF(60, 'Visa-free for 60 days', ['Proof of funds'], 'https://www.thaievisa.go.th/'),
    ...
    CR: VF(180, 'No visa required — up to 180 days. Return ticket required', ['Return ticket']),
    BR: EV(90, 'e-Visa required for Canadian citizens since April 2025', ['Proof of accommodation'], 'https://brazil.vfsevisa.com/homepage'),
    PA: VF(180, 'No visa required — up to 180 days', ['Proof of funds']),
  },
  // ── United Kingdom ──
  GB: {
    ...
    TR: EV(90, 'e-Visa required — apply at official Turkish e-Visa portal', [], 'https://www.evisa.gov.tr/en/'),
    MX: VF(180, 'No visa required — up to 180 days'),
    CR: VF(180, 'No visa required — up to 180 days', ['Return ticket']),
    BR: VF(90, 'No visa required for UK citizens — up to 90 days'),
    PA: VF(90, 'No visa required — up to 90 days (land/air)', ['Return ticket']),
  },
  // ── Germany / EU Schengen ──
  DE: {
    ...
    CU: EV(30, 'Cuba e-Visa required — apply online', ['Cuba e-Visa', 'Travel insurance (mandatory)'], 'https://evisacuba.cu/en/inicio'),
    TH: VF(60, 'Visa-free for 60 days', [], 'https://www.thaievisa.go.th/'),
    TR: VF(90, 'Visa-free for EU/Schengen passport holders (except Cyprus)'),
    MX: VF(180, 'No visa required — up to 180 days'),
    CR: VF(180, 'No visa required — up to 180 days'),
  ...
  AU: {
    ...
    MX: VF(180, 'No visa required — up to 180 days'),
    CR: VF(180, 'No visa required — up to 180 days'),
    BR: EV(90, 'e-Visa required for Australian citizens since April 2025', ['Proof of accommodation'], 'https://brazil.vfsevisa.com/homepage'),
    PA: VF(180, 'No visa required — up to 180 days'),
  },
  // ── New Zealand ──
  NZ: {
    VE: VF(90, 'Visa-free for New Zealand passport holders — up to 90 days', ['Return ticket'], 'https://cancilleriadigital.mppre.gob.ve/login'),
    CO: VF(90, 'No visa required — up to 90 days'),
    ...
    TH: VF(60, 'Visa-free for 60 days', [], 'https://www.thaievisa.go.th/'),
    TR: EV(90, 'e-Visa required', [], 'https://www.evisa.gov.tr/en/'),
    MX: VF(180, 'No visa required'),
    CR: VF(180, 'No visa required — up to 180 days'),
    BR: VF(90, 'No visa required for NZ citizens'),
    PA: VF(180, 'No visa required'),
  },
  // ── Japan ──
  JP: {
    VE: VF(90, 'Visa-free for Japanese passport holders'),
    CO: VF(90, 'No visa required — up to 90 days'),
    DO: VF(30, 'Visa-free — no e-Ticket required for Japanese passport', ['Return ticket'], 'https://viajerodigital.mitur.gob.do/english/'),
    CU: EV(90, 'Cuba e-Visa required as of 2026 — old tourist card no longer valid. Apply at evisacuba.cu', ['Cuba e-Visa', 'Travel insurance (mandatory)', 'D\'Viajeros form'], 'https://evisacuba.cu/en/inicio'),
    TH: VF(60, 'Visa-free for 60 days'),
    TR: VF(90, 'Visa-free for Japanese passport'),
    MX: VF(180, 'No visa required'),
    CR: VF(180, 'No visa required'),
    BR: VF(90, 'No visa required'),
    PA: VF(180, 'No visa required'),
  },
  // ── South Korea ──
  KR: {
    VE: VF(90, 'Visa-free for Korean passport holders'),
  ...
  // ── Russia ──
  RU: {
    VE: VF(90, 'Visa-free for Russian passport holders'),
    ...
    DO: VF(30, 'Visa-free', ['e-Ticket required online'], 'https://viajerodigital.mitur.gob.do/english/'),
    CU: VF(90, 'Visa-free for Russian passport holders — up to 90 days under bilateral agreement', ['Return ticket', 'Travel insurance (mandatory)', 'D\'Viajeros form']),
    TH: VF(60, 'Visa-free for 60 days'),
    TR: VF(60, 'Visa-free for Russian passport — up to 60 days'),
    MX: VF(180, 'No visa required'),
  ...
  TT: {
    ...
    TR: EV(30, 'e-Visa required — apply online', [], 'https://www.evisa.gov.tr/en/'),
    MX: VF(180, 'No visa required'),
    CR: VF(30, 'No visa required — up to 30 days'),
    BR: VR(null, 'Visa required — apply at Brazilian consulate', ['Medical invitation letter', 'Medical documents'], 'https://brazil.vfsevisa.com/homepage'),
    PA: VF(90, 'No visa required — up to 90 days'),
  },
  // ── Jamaica ──
  JM: {
    ...
    BR: VR(null, 'Visa required', ['Medical invitation letter'], 'https://brazil.vfsevisa.com/homepage'),
    PA: VF(90, 'No visa required'),
  },
  // ── Barbados ──
  BB: {
    ...
    DO: VF(90, 'Visa-free for CARICOM members', ['e-Ticket required online'], 'https://viajerodigital.mitur.gob.do/english/'),
    CU: VF(28, 'Visa-free for Barbadian citizens — up to 28 days under bilateral agreement', ['Return ticket', 'Proof of funds']),
    TH: EV(30, 'e-Visa required', [], 'https://www.thaievisa.go.th/'),
    TR: EV(30, 'e-Visa required', [], 'https://www.evisa.gov.tr/en/'),
    MX: VF(180, 'No visa required'),
    CR: VF(30, 'No visa required'),
  ...
  IN: {
    ...
    CU: EV(90, 'Cuba e-Visa required as of 2026 — old tourist card replaced. Apply at evisacuba.cu', ['Cuba e-Visa', 'Travel insurance (mandatory)', 'D\'Viajeros form'], 'https://evisacuba.cu/en/inicio'),
    TH: AC(15, 'Visa on arrival — 15 days. Or apply for e-Visa online for longer stays', ['Visa on arrival fee (THB 2,000)'], 'https://www.thaievisa.go.th/'),
    TR: EV(30, 'e-Visa required — apply at official Turkish e-Visa portal', [], 'https://www.evisa.gov.tr/en/'),
    MX: VR(null, 'Visa required unless holding valid US/Canada/Schengen/UK/Japan visa', ['Valid third-country visa (if applicable)'], 'https://consulmex.sre.gob.mx/'),
    CR: VR(null, 'Visa required — apply at Costa Rican consulate', ['Medical invitation letter'], 'https://www.migracion.go.cr/'),
    BR: VR(null, 'Visa required — apply at Brazilian consulate', ['Medical invitation letter', 'Return ticket'], 'https://brazil.vfsevisa.com/homepage'),
    PA: VR(null, 'Visa required unless holding valid US/UK/Canada/Australia/Schengen visa', ['Medical invitation letter'], 'https://www.embassyofpanama.org/visas-1'),
  },
  // ── China ──
  CN: {
    VE: VR(null, 'Visa required — apply at Venezuelan embassy', ['Medical invitation letter', 'Two passport photos'], 'https://cancilleriadigital.mppre.gob.ve/login'),
    ...
    TH: AC(15, 'Visa on arrival — 15 days. e-Visa available for longer stays', ['Visa on arrival fee (THB 2,000)'], 'https://www.thaievisa.go.th/'),
    TR: EV(30, 'e-Visa required', [], 'https://www.evisa.gov.tr/en/'),
    MX: VR(null, 'Visa required unless holding valid US/Canada/Schengen/UK/Japan visa', ['Medical invitation letter'], 'https://consulmex.sre.gob.mx/'),
    CR: VR(null, 'Visa required', ['Medical invitation letter'], 'https://www.migracion.go.cr/'),
    BR: VF(90, 'Visa-free for Chinese citizens since March 2026 — up to 90 days'),
    PA: VR(null, 'Visa required unless holding valid US/UK/Canada/Australia/Schengen visa', ['Medical invitation letter'], 'https://www.embassyofpanama.org/visas-1'),
  },
  // ── Nigeria ──
  NG: {
    ...
    MX: VR(null, 'Visa required unless holding valid US/Canada/Schengen/UK/Japan visa', ['Medical invitation letter'], 'https://consulmex.sre.gob.mx/'),
    CR: VR(null, 'Visa required', ['Medical invitation letter'], 'https://www.migracion.go.cr/'),
    BR: VR(null, 'Visa required', ['Medical invitation letter', 'Bank statements'], 'https://brazil.vfsevisa.com/homepage'),
    PA: VR(null, 'Visa required', ['Medical invitation letter'], 'https://www.embassyofpanama.org/visas-1'),
  },
  // ── Brazil ──
  BR: {
    ...
    MX: VF(180, 'No visa required'),
    CR: VF(90, 'No visa required'),
    BR: VF(90, 'N/A — Brazil is your home country'),
    PA: VF(90, 'No visa required'),
  },
  // ── Colombia ──
  CO: {
    VE: VF(90, 'Visa-free — bilateral agreement'),
    CO: VF(90, 'N/A — Colombia is your home country'),
    DO: VF(30, 'Visa-free', ['e-Ticket required online'], 'https://viajerodigital.mitur.gob.do/english/'),
    CU: EV(90, 'Cuba e-Visa required as of 2026 — old tourist card no longer valid. Apply at evisacuba.cu', ['Cuba e-Visa', 'Travel insurance (mandatory)', 'D\'Viajeros form'], 'https://evisacuba.cu/en/inicio'),
    TH: VF(60, 'Visa-free for 60 days'),
    TR: VF(90, 'Visa-free'),
  ...
  MX: {
    ...
    TH: VF(60, 'Visa-free for 60 days'),
    TR: EV(90, 'e-Visa required', [], 'https://www.evisa.gov.tr/en/'),
    MX: VF(180, 'N/A — Mexico is your home country'),
    CR: VF(90, 'No visa required'),
    BR: VF(90, 'No visa required'),
    PA: VF(90, 'No visa required'),
  },
  ...
  // ── South Africa ──
  ZA: {
    VE: VF(90, 'Visa-free for South African passport holders — up to 90 days', ['Return ticket', 'Proof of funds']),
    CO: VF(90, 'Visa-free — South African citizens can enter Colombia for up to 90 days without a visa', ['Return ticket', 'Proof of funds']),
    ...
    TR: EV(30, 'e-Visa required', [], 'https://www.evisa.gov.tr/en/'),
    MX: VR(null, 'Visa required — apply at Mexican consulate', ['Medical invitation letter'], 'https://consulmex.sre.gob.mx/'),
    CR: VR(null, 'Visa required', ['Medical invitation letter'], 'https://www.migracion.go.cr/'),
    BR: VR(null, 'Visa required', ['Medical invitation letter'], 'https://brazil.vfsevisa.com/homepage'),
    PA: VR(null, 'Visa required unless holding valid US/UK/Canada/Schengen visa', ['Medical invitation letter'], 'https://www.embassyofpanama.org/visas-1'),
  },
  // ── Philippines ──
  PH: {
