...
const CATEGORIES = [
  { id: 'doctors',  label: 'Doctor',   emoji: '🩺', color: '#22c55e' },
  { id: 'clinic',   label: 'Clinic',   emoji: '🏥', color: '#00E5FF' },
  { id: 'hospital', label: 'Hospital', emoji: '🚑', color: '#ef4444' },
  { id: 'pharmacy', label: 'Pharmacy', emoji: '💊', color: '#a855f7' },
  { id: 'police',   label: 'Police',   emoji: '🚔', color: '#3b82f6' },
  { id: 'embassy',  label: 'Embassy',  emoji: '🏛️',  color: '#D4AF37' },
];
