/**
 * WhatsAppButton — upgraded Assistance pill.
 *
 * Replaces the old Assistance pill. Positioned bottom-left.
 * Click opens a popover with:
 *   1. WhatsApp — primary (direct to concierge)
 *   2. AI Assistant — secondary (Safe-T4life panel)
 *   3. SOS Channel Status strip (Satellite, goTenna, inReach, SMS, QR, Web Share)
 */
      ...
      >
        <div ref={menuRef} style={{ position: 'relative' }}>
          ...
          <motion.button
            ...
            aria-label="WhatsApp assistance — tap for options"
