...
import { ShieldAlert, ShieldCheck, MessageCircle, Bot } from 'lucide-react';
import SafeTAssistantPanel from './SafeTAssistantPanel';

/**
 * FloatingSOSButton — pill stack, bottom-right, z-9999.
 *
 * Top pill:    Assistance → opens 2-option menu (WhatsApp primary, AI secondary)
 * Bottom pill: SOS        → navigates to /emergency
 */

const WHATSAPP_NUMBER = '18005550199';
const WHATSAPP_URL = `https://wa.me/${WHATSAPP_NUMBER}?text=Hello%20Morales%20Concierge%2C%20I%20need%20assistance.`;
    ...
    <>
      ...
      >
        ...
        <div ref={menuRef} style={{ position: 'relative' }}>
            ...
            {isMenuOpen && (
              ...
              >
                ...
                >
                  ...
                  <div>
                    <p style={{ margin: 0, fontSize: 13, fontWeight: 700, color: '#25D366', lineHeight: 1.2 }}>WhatsApp</p>
          ...
          {/* Assistance pill button */}
          <motion.div
            onClick={() => setIsMenuOpen(v => !v)}
            role="button"
            tabIndex={0}
            aria-label="Get assistance — WhatsApp or AI"
            ...
            whileHover={{ scale: 1.04, boxShadow: '0 12px 48px rgba(0,0,0,0.55), 0 0 0 1px rgba(52,211,153,0.35)', transition: { duration: 0.18 } }}
            whileTap={{ scale: 0.97 }}
          >
            <div style={{ position: 'relative', width: 14, height: 14, display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
              ...
              />
              <span style={{ position: 'relative', width: 10, height: 10, borderRadius: '50%', background: '#34d399', boxShadow: '0 0 6px rgba(52,211,153,0.6)', display: 'block' }} />
            </div>
            <ShieldCheck style={{ width: 16, height: 16, color: '#34d399', filter: 'drop-shadow(0 0 4px rgba(52,211,153,0.5))', flexShrink: 0 }} strokeWidth={2} />
...
function WhatsAppIcon({ size = 16 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="#25D366" flexShrink="0">
