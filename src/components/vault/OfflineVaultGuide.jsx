    ...
    <div className="space-y-6">
      ...
      >
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            <h2 className="text-lg font-semibold text-white">Offline Vault Access Guide</h2>
        ...
        <div className="grid gap-4 md:grid-cols-2">
          <div className="bg-emerald-950/50 border border-emerald-700/30 rounded-xl p-4">
            <div className="flex items-center gap-2 mb-3">
              ...
              <h3 className="text-sm font-semibold text-emerald-100">How It Works</h3>
            </div>
          ...
          <div className="bg-blue-950/50 border border-blue-700/30 rounded-xl p-4">
            <div className="flex items-center gap-2 mb-3">
              ...
              <h3 className="text-sm font-semibold text-blue-100">When to Use</h3>
            </div>
      ...
      <div className="grid gap-4 md:grid-cols-3">
        ...
        >
          ...
          <h3 className="text-sm font-semibold text-white mb-2">📱 Device-Specific</h3>
          <p className="text-xs text-slate-300">
        ...
        >
          ...
          <h3 className="text-sm font-semibold text-white mb-2">🔑 No Account Needed</h3>
          <p className="text-xs text-slate-300">
      ...
      <div className="bg-amber-900/20 border border-amber-700/40 rounded-xl p-4">
        <div className="flex items-start gap-3">
          ...
          <div>
            <h3 className="text-sm font-semibold text-amber-200 mb-1">⚠️ Important Notes</h3>
