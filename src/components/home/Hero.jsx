      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center min-h-[calc(100vh-7rem)]">
          ...
          >
            ...
            <p className="text-base lg:text-lg text-muted-foreground max-w-md mb-4 leading-relaxed">
              Premium dental, aesthetic & wellness care with door-to-door concierge service.
              Save 30–40% versus US & Canadian pricing — without compromising on quality.
            </p>
