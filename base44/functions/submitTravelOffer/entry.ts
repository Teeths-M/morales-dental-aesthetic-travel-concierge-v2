...
Deno.serve(async (req) => {
  try {
    ...
    const data = { agency_id: agency.id, patient_request_id: body.patient_request_id, patient_id: request?.patient_id, total_price_usd: Number(body.total_price_usd), flight_details: body.flight_details, hotel_name: body.hotel_name, hotel_address: body.hotel_address };
