...
Deno.serve(async (req) => {
  try {
    ...
    const data = { driver_id: driver.id, patient_request_id: body.patient_request_id, home_to_airport_price: Number(body.home_to_airport_price), airport_to_home_price: Number(body.airport_to_home_price) };
