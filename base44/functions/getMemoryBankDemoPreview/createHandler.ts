...
// directory (Base44 support / Estee, 2026-07-26). Keep this in sync with the
// canonical _shared/createHandler.ts by hand. Per Base44 support, a clean deploy of
// this self-contained version should migrate this function onto the Cloudflare
